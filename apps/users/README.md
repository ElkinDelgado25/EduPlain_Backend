...
El comando `python manage.py bootstrap_superuser` crea de forma idempotente la identidad definida por las variables `EDUPLAIN_BOOTSTRAP_ADMIN_*`. Asigna el rol configurado, oculta la cuenta del directorio público y no eleva usuarios normales que ya existan.
